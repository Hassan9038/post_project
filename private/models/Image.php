<?php 
/**
 * Image croper resizer
 */
class Image
{
	
	public function crop($src_image_path ,$des_image_path , $max_size = 600)
	{
		if ($src_image_path) {
			...
			if ($src_image) {
				...
				$dst_image = imagecreatetruecolor($max_size, $max_size);
		     	...
		     	imagejpeg($dst_image ,$des_image_path);
			}
	...
	public function profile_thumb($image_path)
	{
		...
		if (!file_exists($thumbnail)) {
			// code...
			$this->crop($image_path ,$thumbnail , $corp_size = 600);
