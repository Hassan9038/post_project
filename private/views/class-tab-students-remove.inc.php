...
<form method="post" class="m-auto p-3" style="width: 100% ; max-width: 400px">
	...
	<?php endif; ?>
	<!-- End Errors -->
	<h4 class="mt-2">Remove student</h4>
	<input value="<?= get_var('name')?>"  autofocus type="text" class="form-control" name="name" placeholder="Add student">
	<br>
